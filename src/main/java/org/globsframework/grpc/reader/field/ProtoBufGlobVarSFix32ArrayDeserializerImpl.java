...
public record ProtoBufGlobVarSFix32ArrayDeserializerImpl(GlobSetIntArrayAccessor setAccessor) implements ProtoBufFieldDeserializer {
    ...
    public void read(MutableGlob mutableGlob, SafeHeapReader reader) throws IOException {
        setAccessor.set(mutableGlob, reader.readSFixed32List());
    }
