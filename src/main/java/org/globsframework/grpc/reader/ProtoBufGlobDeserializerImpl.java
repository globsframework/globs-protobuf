...
public final class ProtoBufGlobDeserializerImpl implements ProtoBufGlobDeserializer {
    ...
    private ToGlobCaller<SafeHeapReader, Void, Void> caller;
     ...
     * ToGlobFunction : a generated one holds each leaf in a static final field and dispatches through a
    ...
    public void initCaller(GlobType type) {
        ...
        SortedMap<Integer, ToGlobFunction<SafeHeapReader, Void, Void>> functions = new TreeMap<>();
